...
{
    public partial class frmNonReturningCustomerNotes : Form
    {
        public frmNonReturningCustomerNotes(string accRef)
        {
            InitializeComponent();
            _accRef = accRef;
            populateNotes();
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (checkRecordExists() == true)
            {
                SqlCommand cmd = new SqlCommand("update dbo.crm_do_not_contact set notes_of_conversation = @notes, contacted_date =@date, contacted_by = @contactBy where customer_acc_ref = @accRef", conn);
